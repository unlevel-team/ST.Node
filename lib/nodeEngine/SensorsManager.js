	...
	setNodeControlService(nodeCtrlSrv) {
		...
		smng.nodeCtrlSrv = nodeCtrlSrv;
		  ...
		  // Message getSensorsList
			smng.nodeCtrlSrv.socket.on( smng.CONSTANTS.Messages.getSensorsList, function(msg){
		  ...
		  // · · · · · ·  ¨¨¨  · · · · · ·  ¨¨¨  · · · · · ·  ¨¨¨  · · · · · · |\/|···  
		  // Message StartSensor
			smng.nodeCtrlSrv.socket.on( smng.CONSTANTS.Messages.StartSensor, function(msg){
...
//				msg.result = response.result;
		  ...
		  // · · · · · ·  ¨¨¨  · · · · · ·  ¨¨¨  · · · · · ·  ¨¨¨  · · · · · · |\/|···  
		  // Message StopSensor
			smng.nodeCtrlSrv.socket.on( smng.CONSTANTS.Messages.StopSensor, function(msg){
...
//				msg._done(response);
		  ...
		  // Message TurnOffSensors
			smng.nodeCtrlSrv.socket.on( smng.CONSTANTS.Messages.TurnOffSensors, function(msg){
...
//					msg._done(response);
	...
	getSensorOptions(sns){
		...
		if ( act.sensorEngine != null ) {
			snsOptions.engineOptions = act.sensorEngine.getOptions();
		}
	...
	setSensorOptions(sensor, options){
		...
		amng.eventEmitter.emit(amng.CONSTANTS.Events.SensorOptionsUpdated, {"sensor": sensor});
	}
