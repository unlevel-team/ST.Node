...
let COMSys_Morse_Srv_Node = require('./cysMorse_Services.js').COMSys_Morse_Srv_Node;
let COMSys_Morse_Srv_Server = require('./cysMorse_Services.js').COMSys_Morse_Srv_Server;
...
class COMSystem_Morse extends COMSystem {
	...
	constructor(config) {
		...
		this._service = new COMSys_Morse_Service(this);
